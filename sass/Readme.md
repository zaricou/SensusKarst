...
folder are mapped to the application's root namespace, 'SensusKarst'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SensusKarst"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SensusKarst' in the same way
as `"SensusKarst/sass/src"`.
